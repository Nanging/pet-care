...
import com.stu.petc.beans.Role;
import com.stu.petc.beans.User;
import com.stu.petc.config.RedisConfiguration;
...
//        
        ...
        User user =new User();
        user.setUsername("adminRedis");
        user.setUser_role("管理员REDIS");
//        user.setLoginName("adminRedis");
//        user.setCreatedate(new Date());
//        user.setRoleList(roleList);
//        user.setDepartment(department);
        logger.info("key:" + this.getClass().getName()+":userByLoginName:"+user.getUsername());
        userRedis.deleteByKey(this.getClass().getName()+":userByLoginName:"+user.getUsername());
    ...
    public User getUserRedis(String loginName){
        ...
        logger.info("===user=== name:{},loginName: {},departmentName:{}, roleName:{}",
                user.getUsername(),user.getUser_role());
        return user;
    }
}
